...
<div class="col-lg-8">
    <form method="post" action="/BeritaAdmin/{{ $post->slug }}" enctype="multipart/form-data">
      @method('put')
        @csrf
        ...
        <div class="mb-3">
         ...
         <select name="kategori_id" id="category_id" class="form-select @error('category') is-invalid @enderror">
          @foreach( $categories as $category)
          @if(old('category_id', $post->kategori_id) == $category->id)
...
<script>
  ...
  title.addEventListener('change', function(){
    fetch('/BeritaAdmin/checkSlug?title=' + title.value)
